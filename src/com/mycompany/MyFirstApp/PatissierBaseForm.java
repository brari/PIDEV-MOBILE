 ...
 * @author brari
 */
public class PatissierBaseForm extends Form{
    public PatissierBaseForm() {
    }

    public PatissierBaseForm(Layout contentPaneLayout) {
        super(contentPaneLayout);
    }

    public PatissierBaseForm(String title, Layout contentPaneLayout) {
    ...
    protected void addSideMenu(Resources res) {
        ...
        tb.addMaterialCommandToSideMenu("Prpduit", FontImage.MATERIAL_UPDATE, e -> new afficherReclamationForm(res).show());
