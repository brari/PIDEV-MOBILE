 ...
 * @author brari
 */
public class AdminBaseForm extends Form{
  public AdminBaseForm() {
    }

    public AdminBaseForm(Layout contentPaneLayout) {
        super(contentPaneLayout);
    }

    public AdminBaseForm(String title, Layout contentPaneLayout) {
    ...
    protected void addSideMenu(Resources res) {
        ...
        tb.addMaterialCommandToSideMenu("Reclamation", FontImage.MATERIAL_UPDATE, e -> new afficherReclamationForm(res).show());
